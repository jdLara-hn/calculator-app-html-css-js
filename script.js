...
function addValue(value) {
    if (value === '.') {
        ...
        // check if this is the first decimal in the current number of if the expression is empty
...
function evaluateExpression() {
    ...
    // checks if not a number or infinite. It if is, return a space character
...
function percentage() {
    // evaluate te expression, else it will take the percentage of only the first number
    if (expression !== '') {
        result = evaluateExpression();
        expression = '';
